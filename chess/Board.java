    ...
    public Board(String newBoard) {
    	...
    	for(int ii = 0; ii < 64; ii++){
			...
			if(newBoard.charAt(i+1) == 'R')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new Rook(pieceColor);
			if(newBoard.charAt(i+1) == 'N')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new Knight(pieceColor);
			if(newBoard.charAt(i+1) == 'B')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new Bishop(pieceColor);
			if(newBoard.charAt(i+1) == 'Q')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new Queen(pieceColor);
			if(newBoard.charAt(i+1) == 'K')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new King(pieceColor);
			if(newBoard.charAt(i+1) == 'p')
		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = new Pawn(pieceColor);
//			if(newBoard.charAt(i+1) == '#' || newBoard.charAt(i+1) == ' ')
//		        board[Math.max((int) Math.floor((double)(i)/16),0)][(i/2)%8] = null;
